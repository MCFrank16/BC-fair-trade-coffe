    ...
    ConsumerRole
{
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "The call is not verified");
        _;
    }
    ...
    modifier harvested(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be harvested"
        );
        _;
    }
    ...
    modifier processed(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be processed"
        );
        _;
    }
    ...
    modifier packed(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be packed"
        );
        _;
    }
    ...
    modifier forSale(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be for sale"
        );
        _;
    }
    ...
    modifier sold(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be sold"
        );
        _;
    }
    ...
    modifier received(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be received"
        );
        _;
    }
    ...
    modifier purchased(uint256 _upc) {
        require(
            ...
            "Waiting for the item to be purchased"
        );
        _;
    }
    ...
    function processItem(uint256 _upc)
        ...
        harvested(_upc)
        onlyFarmer
        // call modifier to verify call of this function
